...
-- Baseado na aula "Introdução à Criação de Bancos de Dados"
-- =========================================================
...
-- ---------------------------------------------------------
-- Consultas de exemplo (conforme pedido na atividade)
-- ---------------------------------------------------------
SELECT * FROM voos;

-- Exemplos extras úteis para explorar o banco:
-- SELECT * FROM voos WHERE status = 'Embarque';
-- SELECT * FROM voos WHERE destino = 'Brasilia';
